        ...
        <div class="w-full flex lg:flex-row flex-col gap-[163px] justify-between max-lg:gap-11">
            <div class="w-full flex flex-col text-justify max-md:text-center max-md:w-full">
                ...
                <div
                    ...
                    <br />
                    <br />
                    Como fazer parte da ENGAGE?
                </div>
            </div>
            <div class="w-full flex flex-col gap-[47px] font-normal max-md:w-full">
                <div class="flex items-stretch gap-[35px]">
                    <div
                        class="bg-[rgba(125,75,206,1)] font-Kufam text-xl text-white font-normal w-[86px] h-[86px] flex items-center justify-center rounded-full">
                        01
                    </div>
